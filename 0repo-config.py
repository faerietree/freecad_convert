...
REPOSITORY_BASE_URL = "http://raw.githubusercontent.com/faerietree/freecad_convert/master/public"
...
# for other options).
GPG_SIGNING_KEY = "0xB3A8111C1A7ACA0F006FFE3F7D7D575F70D17325"
...
ARCHIVES_BASE_URL = "https://sourceforge.net/projects/"
...
def get_archive_rel_url(archive_basename, impl):
	...
	return "{program}/files/{version}/{archive}".format(
...
def upload_archives(archives):
	for dir_rel_url, files in paths.group_by_target_url_dir(archives):
		...
		user = 'worlddeveloper'#'sf-user-name'
...
# Pass, because it takes some time till a file appears on sourceforge.
