	...
	<xsl:template match="/zi:interface">
		<html>
			<head>
				...
				<link rel="stylesheet" type="text/css" href='http://raw.githubusercontent.com/faerietree/freecad_convert/master/public//resources/feed.css'/>
			</head>
			<body>
				<div class="site">
					<div class="title">
						<a href="http://raw.githubusercontent.com/faerietree/freecad_convert/master/public/">http://raw.githubusercontent.com/faerietree/freecad_convert/master/public/</a>
					</div>
					<div class="main">
						<div class="content">
